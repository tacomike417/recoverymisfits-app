(() => {
  ...
  function create(ctx) {
    ...
    function setScreenShake(value) {
      screenShake = Number(value) || 0;
    }

    function getBillPickupBounce() {
      return billPickupBounce;
    }

    function setBillPickupBounce(value) {
      billPickupBounce = Number(value) || 0;
    }

    function getScorePulse() {
      return scorePulse;
    }
