...
(() => {
  ...
  if (!document.getElementById(styleId)) {
    ...
    style.id = styleId;
    style.textContent = `
      /* Keep nav styles self-contained */
      #rm-bottom-nav *{ box-sizing:border-box; }
      #rm-bottom-nav svg{ display:block; }
  ...
  function openModal() {
    ...
    modal.innerHTML = `
      ...
      <div class="rmRow">
        ...
        />
        <button class="rmBtn" id="rmSaveSoberDate" type="button">Save</button>
        <button class="rmBtn rmDanger" id="rmClearSoberDate" type="button">Clear</button>
        <button class="rmBtn" id="rmCloseSoberModal" type="button">Close</button>
      </div>
